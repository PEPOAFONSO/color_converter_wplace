...
(function () {
  const LS_KEY = "lang";
  const KNOWN = ["en","pt","de","es","fr","he","uk","vi","pl","ja","de-CH","nl","ru","tr","it","zh-CN"];
...
function decorateLinks(root = document) {
  ...
  const parts = location.pathname.replace(/^\/+/, "").split("/");
  let repoBase = "";
  if (parts.length && !KNOWN_SET.has((parts[0] || "").toLowerCase()) && !/\.(html?)$/i.test(parts[0])) {
    repoBase = `/${parts[0]}`;
  }
...
window.translations = {
  ...
  he: {
    ...
    studioTitle: "סטודיו",
    genNotice: "משתמש בנקודת הקצה הציבורית של תמונת Pollinations. שירות זה עשוי לרשום הנחיות באופן ציבורי. אין צורך בחשבון.",
    paletteFree: "צבעים חופשיים",
    palettePaid: "צבעים בתשלום",
    tools: "כלים",
    toolPencil: "עיפרון", toolPencilTitle: "עיפרון (P)",
    toolBrush: "מברשת", toolBrushTitle: "מברשת (H)",
    toolEraser: "מחק", toolEraserTitle: "מחק (E)",
    toolPicker: "בחירה", toolPickerTitle: "טפטפת (I)",
    toolFill: "מילוי", toolFillTitle: "מילוי (B)",
    toolLine: "קו", toolLineTitle: "קו (L)",
    toolRect: "מקוש", toolRectTitle: "מלבן (R)",
    toolRectF: "Rect+", toolRectFTitle: "מלבן ממולא (Shift+R)",
    toolCirc: "עיגול", toolCircTitle: "אליפסה/עיגול (O)",
    toolCircF: "עיגול+", toolCircFTitle: "אליפסה ממולא (Shift+O)",
    undo: "בטל", undoTitle: "בטל (Ctrl+Z)",
    redo: "בצע שוב", redoTitle: "בצע שוב (Ctrl+Y)",
    clear: "נקה",
    gridSize: "גודל רשת",
    zoom: "זום",
    showGrid: "הצג רשת",
