...
const translations = {
  ...
  it: {
    ...
    copyFailed: "Errore durante la copia dell'immagine.",
    ...
    uploadSpan: "Clicca, incolla oppure trascina e rilascia",
    hideEyeControls: "Mostra/nascondi controlli di occultamento dei colori (occhi)",
